...
%% A one-time Shock - run this or the random shock section
% 1. Specify the shock
v= zeros(T);
v(2)= 1;
...
suptitle('Question 4&5 under one-time tech shock')
print('q4&51','-dpng')

print -djpeg -r600 q4&51.jpg

%% Change psipi and psiy - change variable and re-run the above code
